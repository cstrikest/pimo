...
#define PICK_ROTATOR_X -39
#define PICK_ROTATOR_Y -40
#define PICK_ROTATOR_Z -41
...
fs_content_export treenode getTranslations();
...
#define v_movetime node_v_movetime->safedatafloat()[0]
...
public:
	...
	fs_content_export void rebuildVisualizationDependencies();
	...
	fs_content_export void onSlotLabelValueChange(AbstractSlot* slot, TreeNode* label, const Variant& newValue);
	fs_content_export void setAllLabelMeshesDirty(StorageObject* obj);
	...
	TreeNode* visualizationDependencies;
...
double lastPickPlaceOffsetTime;
treenode lastPickPlaceOffsetItem;
